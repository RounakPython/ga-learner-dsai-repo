...
pd.Series(graduate['LoanAmount']).value_counts(ascending=False).plot(kind='density', label='Graduate')

#Plotting density plot for 'Graduate'
pd.Series(not_graduate['LoanAmount']).value_counts(ascending=False).plot(kind='density', label='Not Graduate')
